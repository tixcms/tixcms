...
class Curl {
	...
	function simple_ftp_get($url, $file_path, $username = '', $password = '')
	{
	...
	function post($params = array(), $options = array())
	{
	...
	function put($params = array(), $options = array())
	{
		// If its an array (instead of a query string) then format it correctly
		if (is_array($params))
		{
	...
	function delete($params, $options = array())
	{
		// If its an array (instead of a query string) then format it correctly
		if (is_array($params))
		{
	...
	function ssl($verify_peer = TRUE, $verify_host = 2, $path_to_cert = NULL)
	{
		if ($verify_peer)
		{
